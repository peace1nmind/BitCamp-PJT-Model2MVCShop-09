		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<c:forEach var="purchase" items="${saleMap.list }" varStatus="status">
				<tr class="ct_list_pop">
					...
					<%-- 상품명 --%>
					<td align="left"><a
						href="/product/getProduct?prodNo=${purchase.purchaseProd.prodNo }">
					...
					<%-- 정보수정(배송하기) --%>
					<td align="left"><c:if
							test="${menu=='manage' && purchase.purchaseProd.proTranCode=='2' }">
								&nbsp;
								<%-- prodNo가 오면 updateTranCode(tranNo, tranCode) --%>
							<a
								href="/purchase/updateTranCode?&prodNo=${purchase.purchaseProd.prodNo }
																	&tranCode=3">
								배송하기 </a>
						</c:if></td>
				</tr>
